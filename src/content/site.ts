...
export const site = {
  ...
  bio: [
    ...
    "I also conducted research on Speaker-aware Multimodal Video Dialogue Analysis for Social Forecasting as a first co-author with a fellow MS student at [DSLab](https://sites.google.com/site/datasciencelaboratory), Kwangwoon University, South Korea. Following reviewer feedback on the initial manuscript, we substantially revised the research direction, moving from multimodal video analysis to text-based modeling of news articles.",
