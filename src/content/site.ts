...
export const site = {
  ...
  bio: [
    ...
    "Recently, I worked at SentriAI as a full stack AI engineer, where I owned the entire questionnaire answering pipeline and other important frontend/backend features to serve law firms as clients.", 
